 ...
 * Lab 3, Task 1, Part 1
 * 
 * I did not make this file - staff did.
 * I put in the logic for determining
 * which LEDs will be lit based off of
 * ADC voltage.
 */
...
int main(void) {
  ...
  while(1) {
    ...
    // 5.1: Convert ADC_value to resistance in kilo-flag
